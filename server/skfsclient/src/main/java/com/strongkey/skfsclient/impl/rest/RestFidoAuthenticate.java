...
public class RestFidoAuthenticate {
                                    ...
                                    String crossOrigin) throws Exception
    {
        ...
        */
        ...
        System.out.println("REST Authentication test with " + authtype);
        System.out.println("*******************************");
        ...
        System.out.println("\nCalling preauthenticate @ " + resourceLoc);
        ...
        try {
            ...
            switch (responseStatusLine.getStatusCode()) {
                case 200:
                    ...
                    break;
                case 401:
                    System.out.println("Error during pre-authenticate : 401 HMAC Authentication Failed");
                    return;
                case 404:
                    System.out.println("Error during pre-authenticate : 404 Resource not found");
                    return;
                case 400:
                case 500:
                default:
                    System.out.println("Error during pre-authenticate : " + responseStatusLine.getStatusCode() + " " + result);
                    return;
            }
        } finally {
            response.close();
...
//        System.out.println("******************************");
        ...
        //  Make API rest call and get response from the server
        System.out.println("\nCalling authenticate @ " + resourceLoc);
