...
public class SoapFidoActionsOnKey {

    public static void update(String SOAP_URI,
                                int did,
                                String authtype,
                                String credential1,
                                String credential2,
                                ...
                                String status)
    {
        ...
        */
        ...
        try {
            ...
            //  Make update call
            System.out.println("\nCalling update @ " + SOAP_URI + Constants.SKFS_WSDL_SUFFIX);
            String response = port.updatekeyinfo(svcinfo, payload);
            ...
            try {
                ...
                if (error != null && !error.equalsIgnoreCase("")) {
                    System.out.println("*******************************");
                    System.out.println("Error during update : " + error);
                }
            } catch (Exception ex) {
    ...
    public static void deregister(String SOAP_URI,
                            int did,
                            String authtype,
                            String credential1,
                            String credential2,
                            String randomid)
    {
        ...
        */
        ...
        try {
            ...
            System.out.println("\nCalling deregister @ " + SOAP_URI + Constants.SKFS_WSDL_SUFFIX);
            ...
            try {
                ...
                if (error != null && !error.equalsIgnoreCase("")) {
                    System.out.println("*******************************");
                    System.out.println("Error during deregister : " + error);
                }
            } catch (Exception ex) {
                //  continue since there is no error
            }
