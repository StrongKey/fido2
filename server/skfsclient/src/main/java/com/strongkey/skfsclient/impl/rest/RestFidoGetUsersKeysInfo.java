...
import com.strongkey.skfs.requests.GetUsersKeysInfoRequest;
...
public class RestFidoGetUsersKeysInfo {

    public static void getUserKeysInfo(String REST_URI,
                                int did,
                                String authtype,
                                String credential1,
                                String credential2,
                                JsonArray usernames) throws Exception
    {
        /*
        ...
        */
        ...
        // Build request
        GetUsersKeysInfoRequest getkeysinfo = new GetUsersKeysInfoRequest();
        ...
        getkeysinfo.setUsernameArray(usernames);
        ...
        String resourceLoc = REST_URI + Constants.REST_SUFFIX + Constants.REST_GETUSERKEYSINFO_ENDPOINT;
        ...
        try (JsonReader jsonReader = Json.createReader(s)) {
            responseJSON = jsonReader.readArray();
        }
...
//        }
        ...
        System.out.println("GetKeys response : " + responseJSON);
    }
}
