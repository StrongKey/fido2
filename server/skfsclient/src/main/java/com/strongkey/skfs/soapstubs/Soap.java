 ...
 * 
 */
@WebServiceClient(name = "soap", targetNamespace = "http://soap.skfs.strongauth.com/", wsdlLocation = "https://demo.strongkey.com/skfs/soap?wsdl")
public class Soap
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://demo.strongkey.com/skfs/soap?wsdl");
