...
public class SKFEServlet {
    ...
    private u2fServletHelperBeanLocal_v1 lookup_u2fServletHelperBeanLocal_v1() {
        try {
            ...
            return (u2fServletHelperBeanLocal_v1) c.lookup("java:app/fidoserverbeans-4.5.0/u2fServletHelperBean_v1!com.strongkey.skfs.txbeans.v1.u2fServletHelperBeanLocal_v1");
