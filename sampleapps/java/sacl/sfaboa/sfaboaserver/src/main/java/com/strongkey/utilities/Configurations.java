...
public class Configurations {
    ...
    private static final ResourceBundle DEFAULTCONFIGS = ResourceBundle.getBundle("resources.sfaboa-configuration");
    ...
    static{
        try {
            ...
            File customConfigFile = new File(DEFAULTCONFIGS.getString("sfaboa.cfg.property.configlocation"));
    ...
    private static void logConfigurations(ResourceBundle configs){
        ...
        SFABOALogger.logp(Level.FINE, CLASSNAME, "logConfigurations", "SFABOA-MSG-1000", configString.toString());
    }
}
