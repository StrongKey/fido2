...
public class SFABOALogger {
    // Logger for the application
    private static final java.util.logging.Logger LOGGER = java.util.logging.Logger.getLogger("SFABOA", "resources.sfaboa-messages");

    // Load messages for Exceptions
    private static final ResourceBundle MESSAGEBUNDLE = ResourceBundle.getBundle("resources.sfaboa-messages");
