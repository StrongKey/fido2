...
public class SKFSClient {
    ...
    private static final String WSPROTOCOL
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.wsprotocol");
    private static final int SKFSDID
            = Integer.parseInt(Configurations.getConfigurationProperty("sfaboa.cfg.property.did"));
    private static final String AUTHTYPE
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.authtype");
    private static final String ACCESSKEY
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.accesskey");
    private static final String SECRETKEY
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.secretkey");
    private static final String SVCUSERNAME
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.svcusername");
    private static final String SVCPASSWORD
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.svcpassword");
    private static final String PROTOCOL
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.protocol");
    private static final String PROTOCOL_VERSION
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.protocol.version");
    private static final String APIURI
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.apiuri");

    // Registration/Authentication options
    private static final String AUTHENTICATORATTACHMENT
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.fido.reg.option.authenticatorattachment");
    private static final String REQUIRERESIDENTKEY
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.fido.reg.option.requireresidentkey");
    private static final String REG_USERVERIFICATION
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.fido.reg.option.userverification");
    private static final String ATTESTATION
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.fido.reg.option.attestation");
    private static final String AUTH_USERVERIFICATION
            = Configurations.getConfigurationProperty("sfaboa.cfg.property.fido.auth.option.userverification");
    ...
    // Delete a user's keySFABOA-WS-ERR-1003
    ...
    private static String callServer(HttpRequestBase request){
        try(CloseableHttpClient httpclient = HttpClients.createDefault()){
            ...
            SFABOALogger.logp(Level.SEVERE, CLASSNAME, "callSKFSRestApi", "SFABOA-ERR-5001", ex.getLocalizedMessage());
    ...
    private static String getAndVerifySuccessfulResponse(HttpResponse skfsResponse){
        try {
            ...
            if (skfsResponse.getStatusLine().getStatusCode() != 200
                ...
                SFABOALogger.logp(Level.SEVERE, CLASSNAME, "verifySuccessfulCall",
                        "SFABOA-ERR-5001", skfsResponse);
                throw new WebServiceException(SFABOALogger.getMessageProperty("SFABOA-ERR-5001"));
            }
    ...
    private static String calculateHash(String contentToEncode) {
        try {
            ...
            SFABOALogger.logp(Level.SEVERE, CLASSNAME, "calculateHash",
                    "SFABOA-ERR-5000", ex.getLocalizedMessage());
            throw new WebServiceException(SFABOALogger.getMessageProperty("SFABOA-ERR-5000"));
        }
    }
    ...
    private static String calculateHMAC(String secret, String data) {
        try {
            ...
            SFABOALogger.logp(Level.SEVERE, CLASSNAME, "calculateHMAC",
                    "SFABOA-ERR-5000", ex.getLocalizedMessage());
            throw new WebServiceException(SFABOALogger.getMessageProperty("SFABOA-ERR-5000"));
        }
    }
