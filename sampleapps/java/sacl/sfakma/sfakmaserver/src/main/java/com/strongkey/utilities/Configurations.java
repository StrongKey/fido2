...
public class Configurations {
    ...
    private static final ResourceBundle DEFAULTCONFIGS = ResourceBundle.getBundle("resources.sfakma-configuration");
    ...
    static{
        try {
            ...
            File customConfigFile = new File(DEFAULTCONFIGS.getString("sfakma.cfg.property.configlocation"));
    ...
    private static void logConfigurations(ResourceBundle configs){
        ...
        SFAKMALogger.logp(Level.FINE, CLASSNAME, "logConfigurations", "SFAKMA-MSG-1000", configString.toString());
    }
}
