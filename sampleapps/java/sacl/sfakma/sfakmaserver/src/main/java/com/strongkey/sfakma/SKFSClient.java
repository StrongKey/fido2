...
public class SKFSClient {
    ...
    private static final String WSPROTOCOL
            = Configurations.getConfigurationProperty("sfakma.cfg.property.wsprotocol");
    private static final int SKFSDID
            = Integer.parseInt(Configurations.getConfigurationProperty("sfakma.cfg.property.did"));
    private static final String AUTHTYPE
            = Configurations.getConfigurationProperty("sfakma.cfg.property.authtype");
    private static final String ACCESSKEY
            = Configurations.getConfigurationProperty("sfakma.cfg.property.accesskey");
    private static final String SECRETKEY
            = Configurations.getConfigurationProperty("sfakma.cfg.property.secretkey");
    private static final String SVCUSERNAME
            = Configurations.getConfigurationProperty("sfakma.cfg.property.svcusername");
    private static final String SVCPASSWORD
            = Configurations.getConfigurationProperty("sfakma.cfg.property.svcpassword");
    private static final String PROTOCOL
            = Configurations.getConfigurationProperty("sfakma.cfg.property.protocol");
    private static final String PROTOCOL_VERSION
            = Configurations.getConfigurationProperty("sfakma.cfg.property.protocol.version");
    private static final String APIURI
            = Configurations.getConfigurationProperty("sfakma.cfg.property.apiuri");

    // Registration/Authentication options
    private static final String AUTHENTICATORATTACHMENT
            = Configurations.getConfigurationProperty("sfakma.cfg.property.fido.reg.option.authenticatorattachment");
    private static final String REQUIRERESIDENTKEY
            = Configurations.getConfigurationProperty("sfakma.cfg.property.fido.reg.option.requireresidentkey");
    private static final String REG_USERVERIFICATION
            = Configurations.getConfigurationProperty("sfakma.cfg.property.fido.reg.option.userverification");
    private static final String ATTESTATION
            = Configurations.getConfigurationProperty("sfakma.cfg.property.fido.reg.option.attestation");
    private static final String AUTH_USERVERIFICATION
            = Configurations.getConfigurationProperty("sfakma.cfg.property.fido.auth.option.userverification");
    ...
    public static String authenticate(String username, String origin, JsonObject signedResponse,String cip, String agent) throws Exception {
    ...
    // Delete a user's keySFAKMA-WS-ERR-1003
    ...
    private static String callServer(HttpRequestBase request){
        try(CloseableHttpClient httpclient = HttpClients.createDefault()){
            ...
            throw new WebServiceException(SFAKMALogger.getMessageProperty("SFAKMA-ERR-5001"));
        }
    }
    ...
    private static String getAndVerifySuccessfulResponse(HttpResponse skfsResponse){
        try {
            ...
            if (skfsResponse.getStatusLine().getStatusCode() != 200
                ...
                SFAKMALogger.logp(Level.SEVERE, CLASSNAME, "verifySuccessfulCall",
                        "SFAKMA-ERR-5001", skfsResponse);
                throw new WebServiceException(SFAKMALogger.getMessageProperty("SFAKMA-ERR-5001"));
            }
            ...
            SFAKMALogger.logp(Level.SEVERE, CLASSNAME, "verifySuccessfulCall",
                    "SFAKMA-ERR-5001", ex.getLocalizedMessage());
            throw new WebServiceException(SFAKMALogger.getMessageProperty("SFAKMA-ERR-5001"));
        }
    }
    ...
    private static String calculateHash(String contentToEncode) {
        try {
            ...
            SFAKMALogger.logp(Level.SEVERE, CLASSNAME, "calculateHash",
                    "SFAKMA-ERR-5000", ex.getLocalizedMessage());
            throw new WebServiceException(SFAKMALogger.getMessageProperty("SFAKMA-ERR-5000"));
        }
    }
    ...
    private static String calculateHMAC(String secret, String data) {
        try {
            ...
            SFAKMALogger.logp(Level.SEVERE, CLASSNAME, "calculateHMAC",
                    "SFAKMA-ERR-5000", ex.getLocalizedMessage());
            throw new WebServiceException(SFAKMALogger.getMessageProperty("SFAKMA-ERR-5000"));
        }
    }
