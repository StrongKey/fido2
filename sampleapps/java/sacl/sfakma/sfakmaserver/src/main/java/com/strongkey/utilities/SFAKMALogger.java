...
public class SFAKMALogger {
    // Logger for the application
    private static final java.util.logging.Logger LOGGER = java.util.logging.Logger.getLogger("SFAKMA", "resources.sfakma-messages");

    // Load messages for Exceptions
    private static final ResourceBundle MESSAGEBUNDLE = ResourceBundle.getBundle("resources.sfakma-messages");
