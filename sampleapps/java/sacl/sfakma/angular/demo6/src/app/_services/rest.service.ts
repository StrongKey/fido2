...
export class RestService {
    // private pocURL = ConstantsService.baseURL + "/poc/fido2";
    private pocURL = ConstantsService.baseURL + "/sfakma/fido2";
    ...
    preregisterExisting(displayName: string) {
        ...
        let body = { "displayName": displayName,"username": username };
        return this.http.post(restURL, body, { headers: headers_object })
            .toPromise()
            .then(resp => this.extractDataAndHeaders(resp))
            .catch(this.handleError);
    ...
    registerExisting(registerJSON: any) {
        ...
        let body = { "payload": registerJSON ,"username": username};
        return this.http.post(restURL, body, { headers: headers_object})
            .toPromise()
            .then(resp => this.extractDataAndHeaders(resp))
            .catch(this.handleError);
    ...
    deleteFIDOKeys(randomIDs: string[]) {
        ...
        let body = { "keyIds": randomIDs,"username": username  };
        return this.http.post(restURL, body, { headers: headers_object })
            .toPromise()
            .then(resp => this.extractData(resp))
            .catch(this.handleError);
