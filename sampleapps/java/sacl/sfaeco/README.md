# Sample FIDO E-commerce Application
...
## Installation
Follow [the installation instructions](https://docs.strongkey.com/index.php/skfs-home/skfs-sample-code/skfs-sample-code-collection-of-fido-enabled-sample-applications-demonstrating-the-android-client-library-and-sso/skfs-sample-code-sfaeco) to download and install the latest proof of concept application.
