 ...
 * **********************************************
 *
 * A common class for webservice operations to connect to the SFA
...
final class CallWebservice {
     ...
     */
    protected static JSONObject execute(String wsoperation,
        ...
        if (selfsigned) {
            SERVICE_URL = (contextWrapper.getResources().getString(R.string.saclfido_self_signed_webservice_hostport)).concat(wsoperation);
        } else {
            SERVICE_URL = (contextWrapper.getResources().getString(R.string.saclfido_webservice_hostport)).concat(wsoperation);
        }
