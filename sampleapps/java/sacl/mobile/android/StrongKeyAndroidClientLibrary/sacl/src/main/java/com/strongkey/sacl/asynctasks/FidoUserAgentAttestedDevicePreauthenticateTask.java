...
public class FidoUserAgentAttestedDevicePreauthenticateTask implements Callable {
     ...
     */
    public FidoUserAgentAttestedDevicePreauthenticateTask(Context context,
                                                          int did,
                                                          Long uid,
                                                          Long devid,
                                                          Long rdid) {
     ...
     * }
     *
     * However, MDBA gets the following preauthenticate request; the MDBA application
     * back-end is expected to retrieve them from the MDBA's database and relay the
     * request to the FIDO server. Input looks like:
     *
     * {
     *   "mdbaFidoServiceInput": {
     *     "did": 1,
     *     "service": Constants.MDBA_FIDO_SERVICES.MDBA_FIDO_SERVICE_GET_FIDO_AUTHENTICATION_CHALLENGE,
     *     "mdbaCredentials": {
     *       "uid": 87,
     *       "devid": 61,
     *       "rdid": 37
