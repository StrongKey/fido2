...
# Create DB Tables
cd $SKFS_SOFTWARE/fidopolicyboaSQL
...
echo "Deploying StrongKey FIDO Policy BOA ..."
cp $SKFS_SOFTWARE/fidopolicyboa.war /tmp
$GLASSFISH_HOME/bin/asadmin deploy /tmp/fidopolicyboa.war
