...
export class SharedService {
    ...
    private _preauthPolicy: BehaviorSubject<string> = new BehaviorSubject<string>("");
    ...
    public preauthPolicy: Observable<string> = this._preauthPolicy.asObservable();
    ...
    //     let restURL = ConstantsService.baseURL + "/fidopolicyboa/fido2/isLoggedIn";
    ...
    getPreauthPolicy() {
        return this._preauthPolicy.getValue();
    }

    setPreauthPolicy(policy: string) {
        this._preauthPolicy.next(policy);
    }
