 ...
 * **********************************************
 *
 * Utils contain utility functions and extensions
 *
 */

import SwiftUI

// Convert Unix Epoch Timestamp to formatted date and time
...
// Base64URL Extensions to help parsing data from SKFS Servlet
extension String {
