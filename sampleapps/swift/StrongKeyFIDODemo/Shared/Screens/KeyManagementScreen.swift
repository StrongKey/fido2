            ...
            NavigationView {
                VStack {
                    List(viewModel.keys) { item in
                        ...
                        .confirmationDialog("Are you sure you want to delete this key?", isPresented: $isDeleteKeyConfirm) {
                            Button(role: .destructive) {
                            ...
                            Text("You will not be able to use this key to login on any device.")
                        }
                        ...
                        // MARK: - New syntax for alert causing delay compared to older syntax which will be depricated after iOS 15
//                        .alert("Cannot delete this Key", isPresented: $isFinalKey) {
//                            Button("OK") {
//                                // Dismiss
//                            }
//                        } message: {
//                            Text("This is your only key for the account. If you want to delete the account select Delete Account from the Settings Menu top right!")
//                        }
